  ...
  return (
    <div className="flex flex-col w-full gap-4">
      <div className="flex flex-col gap-1">
        <h2 className="text-white font-semibold text-base">Owner Information</h2>
        <p className="text-neutral-400 text-xs">Personal details of the business owner.</p>
      </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <label className="flex items-center gap-2 cursor-pointer">
            ...
            <input
              ...
              className="w-4 h-4 rounded border-neutral-500 bg-neutral-900"
            />
          </label>
        </div>
        <input
